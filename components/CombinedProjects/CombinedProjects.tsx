...
const CombinedProjects = () => {
  return (
    ...
    <div className="flex flex-col gap-10 mb-20">
      <h1 className="text-4xl text-[#D7B56D] text-center font-semibold">Flagship Project</h1>
    ...
    <div className="flex flex-col gap-10 mb-24">
      <h1 className="text-4xl text-[#D7B56D] text-center font-semibold">Ongoing Projects</h1>
      <hr className="border-t-2 border-[#C9C9C9] mx-10" />
